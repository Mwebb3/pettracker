const pg = require('pg');
const client = new pg.Client('postgres://localhost/petclub_db');
...
const init = async()=> {
  ...
  DROP TABLE IF EXISTS owners;
   ...
   INSERT INTO pets(name, owner_id) VALUES ('Rex', (SELECT id FROM owners WHERE name='Lucy'));
   INSERT INTO pets(name) VALUES ('Tiger');
   INSERT INTO pets(name, owner_id) VALUES ('Fluffy', (SELECT id FROM owners WHERE name='Moe'));
  `;
